...
public class Main {
	public static void main(String[] args) {
		...
		for (int tamanho : tamanhos) {
			...
			testAlgorithm("Bubble Sort", BubbleSort::sort, ordenado, reverso, random);
			testAlgorithm("Insertion Sort", InsertionSort::sort, ordenado, reverso, random);
			testAlgorithm("Selection Sort", SelectionSort::sort, ordenado, reverso, random);
			testAlgorithm("Merge Sort", MergeSort::sort, ordenado, reverso, random);
			testAlgorithm("Quick Sort", QuickSort::sort, ordenado, reverso, random);
			testAlgorithm("Bucket Sort", BucketSort::sort, ordenado, reverso, random);
